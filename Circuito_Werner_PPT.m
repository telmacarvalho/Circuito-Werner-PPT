...
gissave('W_completo.mat', 'W_completo');
save('W_PPT.mat','W_PPT');
save('W_Peso.mat', 'W_Peso');
save('W_parcial_SzSy.mat', 'W_parcial_SzSy');
save('W_parcial_SzSx.mat', 'W_parcial_SzSx');
save('W_parcial_SzSxParcial.mat', 'W_parcial_SzSxParcial');
...
title('Classificação por peso utilizando o critério PPT (dados sem erro nos ângulos)')
